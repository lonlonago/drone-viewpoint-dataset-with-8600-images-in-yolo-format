# Drone-viewpoint dataset with 8600 images in YOLO format

# Body

Drone Viewpoint Dataset: 8600 Images in YOLO format
Images are clear, with complete annotations, including pedestrians, vehicles, bicycles, etc., suitable for training object detection models, ready to use directly, saving time and effort
...
Truck
Part of the original description was in Chinese and has been omitted.
Awning-tricycle (with canopy tricycle
Part of the original description was in Chinese and has been omitted.
Motorcycle

By counting the number of images within each category
Pedestrian classification: 240 images
People classification: 461 images
Bicycle classification: 924 images
Car classification: 1197 images
Van classification: 1368 images
Truck classification: 1416 images
Tricycle classification: 1417 images
Awning-Tricycle classification: 1061 images
Bus classification: 446 images
Motor classification: 99 images
